...
def content(want):
    ...
    def HTML():
        ...
        <body>
            ...
            <section>
                ...
                <table>
                    <tr><th>Property</th><th>Results</th></tr>
                    <tr><td>Total memory (GB)</td><td>{total_aRAM}</td></tr>
                    <tr><td>Free memory (GB)</td><td>{free_aRAM}</td></tr>
                    <tr><td>Consumed memory (%)</td><td>{consumed_aRAM}</td></tr>
                    <tr><td>Used-up memory (GB)</td><td>{used_aRAM}</td></tr>
                </table>
                <h4>Virtual RAM</h4>
                <table>
                    <tr><th>Property</th><th>Results</th></tr>
                    <tr><td>Total memory (GB)</td><td>{total_vRAM}</td></tr>
                    <tr><td>Free memory (GB)</td><td>{free_vRAM}</td></tr>
                    <tr><td>Consumed memory (%)</td><td>{consumed_vRAM}</td></tr>
                    <tr><td>Used-up memory (GB)</td><td>{used_vRAM}</td></tr>
                </table>
            </section>
            <section>
                <h3>About Network</h3>
    ...
    def CSS():
        return ""  # Empty since CSS is embedded in HTML

    def JScript():
        return ""  # Empty since JS is embedded in HTML
